...
from game.constants import (
    TEXT_COLOR, MUTED_TEXT, ACCENT, P1_COLOR, P2_COLOR,
...
class ImageSelectScreen:
    ...
    def __init__(self, screen: pygame.Surface, options: dict):
        ...
        self._btn_p1_pick_multi    = Button((p1x_multi, col_btn_y,                 _PREVIEW, col_btn_h), "Pick Image",   self._font_btn, color=(P1_COLOR[0]-20, P1_COLOR[1]-20, P1_COLOR[2]-20), hover_color=P1_COLOR, border_radius=19)
        self._btn_p1_default_multi = Button((p1x_multi, col_btn_y + col_btn_h + 6, _PREVIEW, col_btn_h), "Use Defaults", self._font_btn,
                                             color=BTN_COLOR, hover_color=BTN_HOVER, active_color=BTN_ACTIVE, border_radius=19)

        self._btn_p2_pick    = Button((p2x_multi, col_btn_y,                 _PREVIEW, col_btn_h), "Pick Image",   self._font_btn, color=(P2_COLOR[0]-20, P2_COLOR[1]-20, P2_COLOR[2]-20), hover_color=P2_COLOR, border_radius=19)
        self._btn_p2_default = Button((p2x_multi, col_btn_y + col_btn_h + 6, _PREVIEW, col_btn_h), "Use Defaults", self._font_btn,
                                       color=BTN_COLOR, hover_color=BTN_HOVER, active_color=BTN_ACTIVE, border_radius=19)

        self._btn_p1_pick_single    = Button((p1x_single, col_btn_y,                 _PREVIEW, col_btn_h), "Pick Image",   self._font_btn, color=(P1_COLOR[0]-20, P1_COLOR[1]-20, P1_COLOR[2]-20), hover_color=P1_COLOR, border_radius=19)
