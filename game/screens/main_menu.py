...
Redesigned with a bright, minimalist, and creative aesthetic.
"""
...
class MainMenu:
    def __init__(self, screen: pygame.Surface):
        ...
        self.btn_play    = Button(
            (cx - bw // 2, 450, bw, bh), "P L A Y   G A M E", self._font_btn,
            color=BTN_COLOR, hover_color=BTN_HOVER, active_color=BTN_ACTIVE,
            border_radius=28
        )
        self.btn_options = Button(
            (cx - bw // 2, 525, bw, bh), "O P T I O N S", self._font_btn,
        ...
        self.btn_exit    = Button(
            (cx - bw // 2, 600, bw, bh), "E X I T", self._font_btn,
